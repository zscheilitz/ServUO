...
namespace Server.Engines.Craft
{
    public class CraftGumpItem : Gump
    {
        ...
        public void DrawSkill()
        {
            ...
            bool hasSubRes = resIndex > -1 && resIndex < res.Count;
            double chance = m_CraftItem.GetSuccessChance(m_From, hasSubRes ? res.GetAt(resIndex).ItemType : null, m_CraftSystem, false, ref allRequiredSkills);
